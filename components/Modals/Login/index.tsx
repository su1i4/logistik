    ...
    return (
        <>
            <Modal
                ...
                size="sm" radius="sm" isOpen={isOpen} onOpenChange={onOpenChange}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1 text-milk font-mono">Для администратора <br />  Введите логин и пароль.</ModalHeader>
                            <ModalBody
